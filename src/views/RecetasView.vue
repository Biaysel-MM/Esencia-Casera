        ...
        <div class="max-w-350 mx-auto">
          ...
          <div class="mb-8 space-y-5">
            ...
            <div class="flex flex-wrap gap-2">
              ...
              <button v-if="availableCount > 0" @click="showOnlyAvailable = !showOnlyAvailable"
                :class="[
                  'px-5 py-2.5 rounded-xl text-sm font-medium transition-all',
              ...
              <div class="p-5">
                ...
                <div v-if="recipe.match_percentage !== undefined" class="mb-3">
                  <div class="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                    <div class="h-full bg-emerald-600 rounded-full" :style="{ width: recipe.match_percentage + '%' }"></div>
                  </div>
                  <p class="text-xs text-gray-500 mt-1">{{ recipe.match_percentage }}% de ingredientes disponibles</p>
                </div>
                <button class="w-full py-2 rounded-xl bg-emerald-600 text-white text-sm hover:bg-emerald-700">
                  Ver receta
                </button>
              </div>
            </div>
          ...
          <div v-else class="text-center py-12">
            ...
            <p class="text-gray-500 mt-2">Intenta con otros filtros o <button @click="goToCreateRecipe" class="text-emerald-600">crea tu propia receta</button></p>
          </div>
        </div>
      </main>
    </div>
